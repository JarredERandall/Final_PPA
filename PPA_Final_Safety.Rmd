...
However, when adding a neighborhood effect with the zipcode as last variable to the regression after the k-nearest variable, we get a change of $R^2$ by 0.07, an effect more than 20 times as great than that of k-nearest.
